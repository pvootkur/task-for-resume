 ...
 */
public final class AtmaLogger extends ExtendedLoggerWrapper {
    private static final long serialVersionUID = 173351303429634L;
    private final ExtendedLoggerWrapper logger;

    private static final String FQCN = AtmaLogger.class.getName();
    ...
    private AtmaLogger(final Logger logger) {
     ...
     */
    public static AtmaLogger create() {
        final Logger wrapped = LogManager.getLogger();
        return new AtmaLogger(wrapped);
    }
     ...
     */
    public static AtmaLogger create(final Class<?> loggerName) {
     ...
     * @return The custom Logger.
     */
    public static AtmaLogger create(final Class<?> loggerName, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static AtmaLogger create(final Object value) {
     ...
     * @return The custom Logger.
     */
    public static AtmaLogger create(final Object value, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static AtmaLogger create(final String name) {
     ...
     * @return The custom Logger.
     */
    public static AtmaLogger create(final String name, final MessageFactory messageFactory) {
