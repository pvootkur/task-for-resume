...
public interface IFrmBatchProcessControlRepository{

    public List<FrmBatchProcessControlBO> cmdqueryClick1(FrmBatchProcessControlBO frmbatchprocesscontrolBOReq) throws TASADataAccessException;
